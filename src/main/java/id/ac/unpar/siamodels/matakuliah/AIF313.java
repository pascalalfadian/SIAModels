...
/**
 * Mata kuliah ini memperkenalkan kepada mahasiswa 
 * konsep dasar pembuatan grafik dengan menggunakan komputer seperti mengenal 
 * berbagai algoritma pembuatan primitif 2 dimensi seperti 
 * titik, garis, lingkaran, elips, berbagai macam bentuk kurva, fraktal, konsep warna (RGB), dasar-dasar grafika 3 dimensi seperti pewarnaan, pencahayaan, pemberian tekstur pada objek, transformasi, animasi, dan sebagainya. 
