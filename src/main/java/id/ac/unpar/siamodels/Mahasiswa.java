...
public class Mahasiswa {
     ...
     *
     * @return IPK Lulus, atau {#link {@link Double#NaN}} jika belum mengambil
     * satu kuliah pun.
     ...
     * false jika ingin semua (sama dengan "IP N. Terbaik" di DPS) Sebelum
     * memanggil method ini, {@link #getRiwayatNilai()} harus sudah mengandung
    ...
    /**
     * Menghitung jumlah SKS lulus mahasiswa saat ini. Sebelum memanggil method
     * ini, {@link #getRiwayatNilai()} harus sudah mengandung nilai per mata
     * kuliah!
     *
     * @return SKS Lulus
     */
    ...
    /**
     * Menghitung jumlah SKS tempuh mahasiswa saat ini. Sebelum memanggil method
     * ini, {@link #getRiwayatNilai()} harus sudah mengandung nilai per mata
     * kuliah!
     *
    ...
    /**
     * Mendapatkan seluruh tahun semester di mana mahasiswa ini tercatat sebagai
     * mahasiswa aktif, dengan strategi memeriksa riwayat nilainya. Jika ada
     * satu nilai saja pada sebuah tahun semester, maka dianggap aktif pada
     * semester tersebut.
     *
     ...
     * {@link #getRiwayatNilai()} harus sudah mengandung nilai per mata kuliah!
     * Note: jika yang dimiliki adalah {@link MataKuliah}, gunakanlah
    ...
    public static class Nilai {
        ...
        /**
         * Mengembalikan nilai akhir dalam bentuk huruf (A, B, C, D, ..., atau
         * K)
         *
        ...
        /**
         * Pembanding antara satu nilai dengan nilai lainnya, secara kronologis
         * waktu pengambilan.
         *
         * @author pascal
         *
